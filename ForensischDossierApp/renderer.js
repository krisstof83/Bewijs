...
async function scanPDFs() {
  ...
  // ⚡ Bolt Optimization: Batch SQLite inserts using a transaction and prepared statement
  // This drastically reduces disk fsync operations, speeding up file scanning significantly.
  db.serialize(() => {
