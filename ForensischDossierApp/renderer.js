...
async function scanPDFs() {
  ...
  // ⚡ Bolt Optimization: Batch multiple inserts in a single transaction
  // Measurement: Expected to drastically reduce disk I/O fsync operations and improve scan times.
  db.serialize(() => {
