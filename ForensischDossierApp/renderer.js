...
async function scanPDFs() {
  ...
  // Optimization: Batch multiple inserts into a single transaction to prevent
  // SQLite from syncing to disk on every single record insert, drastically improving performance.
  db.serialize(() => {
