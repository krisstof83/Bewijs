...
async function scanPDFs() {
  ...
  // ⚡ Bolt: Wrap file metadata inserts in a single transaction
  // This reduces SQLite disk I/O overhead from O(N) to O(1) commits, speeding up scan times significantly
  db.serialize(() => {
