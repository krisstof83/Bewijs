...
async function scanPDFs() {
  ...
  // ⚡ Bolt: Batch database inserts inside a transaction with prepared statements
  // to avoid disk fsync bottlenecks. Wrapped in try-catch to avoid transaction leakage.
  db.serialize(() => {
