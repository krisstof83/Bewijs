...
async function scanPDFs() {
  ...
  // ⚡ Bolt Optimization: Batch SQLite inserts with a transaction to reduce disk fsync latency.
  // This drastically improves performance from ~O(N) fsync latency to ~O(1) fsync latency per batch.
  db.serialize(() => {
